        ...
        try {
            await axios.post(
                ...
                isAdmin:true,
                  ...
                  type: "BOOKING",
                  message:
                    `An error happened, the user with booking code ${booking.bookingCode} did not recieve a cancelation with refund message and should be sent maually to this email ${booking.email}`,
                },
              });
            console.log(error)
        }
        ...
        try {
            ...
            await prisma.notification.create({
                ...
                isAdmin:true,
                  ...
                  type: "BOOKING",
                  message:
                    `An error happened, the user with booking code ${booking.bookingCode} did not recieve a cancelation with NO refund message and should be sent maually to this email ${booking.email}`,
                },
              });
            console.log(error)
        }
        ...
        try {
            ...
            await prisma.notification.create({
                ...
                isAdmin:true,
                  ...
                  type: "BOOKING",
                  message:
                    `An error happened, the user with booking code ${booking.bookingCode} did not recieve an update message and should be sent maually to this email ${booking.email}`,
                },
              });
            console.log(error)
        }
