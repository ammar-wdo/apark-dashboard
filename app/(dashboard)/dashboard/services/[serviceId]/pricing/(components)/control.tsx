  ...
  return (
    <section className=" p-3 rounded-sm  text-xs">
      ...
      <div className="grid grid-col-1 md:grid-cols-2 gap-2 mt-4 group">
        <div className="flex flex-col gap-1 p-3 rounded-md border md:group-hover:hover:scale-105 hover:shadow-md transition bg-background group-hover:scale-95 group-hover:opacity-50 group-hover:hover:opacity-100">
        ...
        <div className="flex flex-col gap-1 p-3 rounded-md border md:group-hover:hover:scale-105 group-hover:opacity-50 group-hover:hover:opacity-100 hover:shadow-md transition bg-background group-hover:scale-95">
